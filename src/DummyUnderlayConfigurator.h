...
/**
 * @file DummyUnderlayConfigurator.h
 * @author Alan Davoust
 */

#ifndef __DUMMYUNDERLAYCONFIGURATOR_H__
#define __DUMMYUNDERLAYCONFIGURATOR_H__
 ...
 */
class DummyUnderlayConfigurator : public UnderlayConfigurator
{
public:
    ~DummyUnderlayConfigurator();
...
protected:
    ...
    //overrides superclass init, removed churn generator init
